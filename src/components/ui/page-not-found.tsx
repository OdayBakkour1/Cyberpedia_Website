...
export default function NotFoundPage() {
  return (
    <div className="w-full h-screen bg-slate-900 overflow-x-hidden flex justify-center items-center relative">
      <MessageDisplay />
      <CharactersAnimation />
      <CircleAnimation />
    </div>
...
function MessageDisplay() {
  ...
  // REMOVED: const [isVisible, setIsVisible] = useState(false);
  // REMOVED: useEffect(() => { ... }, []);

  return (
    <div className="absolute flex flex-col justify-center items-center w-[90%] h-[90%] z-[100]">
      <div className="flex flex-col items-center">
        <div className="text-[35px] font-semibold text-cyan-400 m-[1%] font-designer">
          Page Not Found
        </div>
        <div className="text-[80px] font-bold text-cyan-400 m-[1%] font-designer">
          404
        </div>
        <div className="text-[15px] w-1/2 min-w-[40%] text-center text-cyan-400 m-[1%]">
          The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.
        </div>
        <div className="flex gap-6 mt-8">
          <button
            onClick={() => router.back()}
            className="text-cyan-400 border-2 border-cyan-400 hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105 font-designer"
          >
            <svg
          ...
          <button
            onClick={() => router.push("/")}
            className="bg-cyan-400 text-slate-900 hover:bg-cyan-300 transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105 font-designer"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
